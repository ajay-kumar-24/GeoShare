...
public class ViewFriends extends BaseAdapter {
    ...
    public ViewFriends(Activity a, ArrayList<HashMap<String,String>> al) {
        activity = a;
        data = al;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        View vi=convertView;
        if(convertView==null)
            vi = inflater.inflate(R.layout.viewfriends, null);

        TextView fr_name = (TextView)vi.findViewById(R.id.fn); // title
